...
def generate_sales_dashboard(output_dir, start_date, end_date):
    ...
    plt.suptitle(f'Sales Dashboard NAAMA ABDERRAHMANE ({start_date} to {end_date})', fontsize=16)
    ...
    plt.tight_layout()
    output_filename = f'sales_dashboard_NAAMA_{start_date}_to_{end_date}.png'
